...
class PDFMultipleChoiceGenerator:
    def __init__(self, data_dir: str, google_api_key: str, db_path: str = "faiss_index"):
...
def main():
    data_dir = "data"
    google_api_key = config.GOOGLE_API_KEY  # Make sure to update config.py with your Google API key
    db_path = "faiss_index"
    
    mcq_generator = PDFMultipleChoiceGenerator(data_dir, google_api_key, db_path)
